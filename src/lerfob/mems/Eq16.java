...
class Eq16 {
	 ...
	 * @return
	 */
	static double getLCI(Matrix compartments) {	// TODO the definition of C3 is inconsistent with the information moreover, this is input whereas the symbol suggests the current stock in the pool
