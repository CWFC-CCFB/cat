...
//
//		ExtractBroadleaved("Species- or status-based extraction", "Extraction par \u00E9tat ou type d'esp\u00E8ces"), // TODO eventually rename the enum MF2024-02-28
...
//		}
//
//		final BroadleavedExtractionProcessor caller;
//		
//		
...
//		
//		
//		protected StatusSpeciesTypeExtractionProcessorPanel(BroadleavedExtractionProcessor caller) {
//			super();
//			this.caller = caller;
//			statusClassSelection = new ArrayList<Enum>();
//			statusClassSelection.add(BroadleavedExtractionProcessor.MessageID.None);
...
//			speciesTypeSelection.add(BroadleavedExtractionProcessor.MessageID.None);
...
//			if (caller.getSpeciesType() == BroadleavedExtractionProcessor.MessageID.None) {
//				statusClassSelection.remove(BroadleavedExtractionProcessor.MessageID.None);
//			} else {
//				if (!statusClassSelection.contains(BroadleavedExtractionProcessor.MessageID.None)) {
//					statusClassSelection.add(0, BroadleavedExtractionProcessor.MessageID.None);
//				}
//			}
...
//			statusClassComboBox.setSelectedItem(caller.getStatusClass());
//			
//			if (caller.getStatusClass() == BroadleavedExtractionProcessor.MessageID.None) {
//				speciesTypeSelection.remove(BroadleavedExtractionProcessor.MessageID.None);
//			} else {
//				if (!speciesTypeSelection.contains(BroadleavedExtractionProcessor.MessageID.None)) {
//					speciesTypeSelection.add(0, BroadleavedExtractionProcessor.MessageID.None);
//				}
//			}
